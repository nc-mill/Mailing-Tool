...
describe('ws_isolation pod mlain_app', () => {
  ...
  it('všech 92 politik čte kontext přes NULLIF, žádná holým current_setting', async () => {
    ...
    // a 0013 `ws_isolation` na `sender_identities`, tedy 90. 0024 přidala
    // `maintenance_scan` na `imports` a `segments`, tedy 92.
