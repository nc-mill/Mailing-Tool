...
- [ ] Úklid zkušebních dat v `mlain_clean`: kampaně „Odesilatel test A", „Kroky kampane test", „Slouceny krok 1", šablona „Slouceny krok 1 sablona", předvolba odesílatele „Fakturace", segment „Klikli v kampani Slouceny krok 1", kontakt `identify-dukaz@example.cz`
