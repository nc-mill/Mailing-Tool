...
import csOnboarding from '../../../../../packages/i18n/messages/cs/onboarding.json';
import csSettings from '../../../../../packages/i18n/messages/cs/settings.json';

/**
 * Obrazovky onboardingu čtou tři katalogy: vlastní `onboarding`, obecné popisky
 * potvrzovacího dialogu ze `settings` a popisky oznámení z `common`.
 * `useToast` mimo `ToastProvider` navíc vyhodí výjimku, takže ho testy montují taky.
 */
export const MESSAGES = { common: csCommon, onboarding: csOnboarding, settings: csSettings };
